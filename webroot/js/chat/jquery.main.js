...
(function( $ ) {
  ...
  var xhr_dlogin = $.get( url + "views/dialog-login.html", function( dialog_login ) {
    $( "body" ).append( dialog_login );
  });

  var xhr_toolbar = $.get( url + "views/toolbar.html", function( toolbar ) {
    $( "body" ).append( toolbar );
  });
  
  var xhr_mchat = $.get( url + "views/main-chat.html", function( main_chat ) {
    $( "body" ).append( main_chat );
  });

  var xhr_options = $.get( url + "views/options.html", function( options ) {
    $( "body" ).append( options );
  });
