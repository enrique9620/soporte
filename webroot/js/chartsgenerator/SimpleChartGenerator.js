...
function SimpleChartGenerator(url, nombreDiv, tituloPrincipal, color, filtroFecha, altoGrafica, conTabla, tipoTabla) {

        var global = url;
        var obj;
        $.each(global, function (g, glo) {
            obj = glo;
        });
    ...
    //ESTO SE HACE YA QUE LA FECHA SE RECIBE EN FORMATO YYYY-MM-DD Y PARA DAR MÁS VISTA SE CONVIERTE A DD-MM-YYYY
    ...
    //BÁSICAMENTE ES EL MISMO CICLO ANTERIOR, PERO SÓLO GENERA LA TABLA.
    //ANTES SE HACÍA EN UN MISMO CICLO, PERO POR ORGANIZACIÒN ES MEJOR SEPARARLO.

        var filas = 0;
        $.each(obj.data, function (i, item) {
            $.each(item, function (j, itm) {

                //EN CASO DE QUE HAYA MUCHAS MÀS DE UNA SERIE POR ETIQUETA, ENTONCES ENTRA AL CICLO PARA QUE SUME CADA UNO DE LOS ELEMENTOS EN LA TABLA
                ...
                if (tipoTabla == "normal") { //EL IF SE PONE AQUÍ PORQUE NECESITO LOS PROCESOS ANTERIORES
    ...
    //ASIGNA LOS TÍTULOS DE LA TABLA
    ...
    //PARA AHORRAR CÓDIGO, TODAS LAS CONSULTAS TIENEN RANGO DE FECHA, PERO SI EL USUARIO QUIERE QUITAR EL FILTRO DE FECHAS ENTONCES USAMOS
    //UN RANGO MUY GRANDE EJ. 1900-01-01    2050-01-01
    //NO SE DEBE MOSTRAR ESTO EN EL TÍTULO.
        ...
        if ((fechaInicio == '01/01/1900') && (fechaFin == '31/12/2050') && (filtroFecha == true)) {
            ...
            //LE PONE EL TÍTULO PRINCIPAL A TODO EL DIV. COMO UTILIZA prepend LO PONE AL INICIO.
