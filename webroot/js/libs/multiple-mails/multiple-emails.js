(function( $ ){
	...
	$.fn.multiple_emails = function(options) {
		...
		{
			deleteIconHTML = '<a href="#" class="btn btn-link" title="Remove"><span class="glyphicon glyphicon-remove"></span></a>';
		}
			...
			deleteIconHTML = '<a href="#" class="btn btn-link" title="Remove"><i class="remove icon"></i></a>';
		}
		else if (settings.theme.toLowerCase() == "Basic".toLowerCase()) {
			//Default which you should use if you don't use Bootstrap, SemanticUI, or other CSS frameworks
			deleteIconHTML = '<a href="#" class="btn btn-link" title="Remove"><i class="basicdeleteicon">Quitar</i></a>';
		}
