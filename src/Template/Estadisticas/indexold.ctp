...
<!--         <ul id="tabsJustified" class="nav nav-tabs">
                    <li class="nav-item"><a href="#datos_d" data-target="#home1" data-toggle="tab" class="nav-link small text-uppercase">Abiertos/Cerrados</a></li>
                    <li class="nav-item"><a href="#datos_t" data-target="#profile1" data-toggle="tab" class="nav-link small text-uppercase active">Por usuario</a></li>
         </ul> -->
